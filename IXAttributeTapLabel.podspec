#
#  Be sure to run `pod spec lint IXAttributeTapLabel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "seven" => "seven.song@ixdigit.com" }
  ...
  s.source       = { :git => "https://github.com/NSSONGMENG/AttributeStringDemo.git", :tag => "v1.0.0" }
